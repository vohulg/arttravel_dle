<div class="bcomment">
	...
	<div class="dcont">
		[lastcomments]<h3 style="margin-bottom: 0.4em;">{news_title}</h3><div align="center" style="float:right;padding:3px;margin-right:3px;">[fullimageurl]{thumb}[/fullimageurl]</div>[/lastcomments]{comment}
