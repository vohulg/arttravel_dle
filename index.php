...
if (strpos ( $tpl->result['content'], "hs.expand" ) !== false or strpos ( $tpl->copy_template, "hs.expand" ) !== false) {
	...
	// if ($config['thumb_gallery'] AND ($dle_module == "showfull" OR $dle_module == "static") ) { // раскомментировать при удалении модификации
// TWS Gallery Setup begin
	if ($dle_module == "gallery" || ($config['thumb_gallery'] AND ($dle_module == "showfull" OR $dle_module == "static") ) ) {
